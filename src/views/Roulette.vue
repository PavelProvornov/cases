<template>
    ...
    <div class="roulette">
        <div class="roulette-jackpot">
                    ...
                    <div class="roulette-item clone" v-for='(n, index) in 3' :key="index+100">
                      ...
                      <div class="item-inner" v-if="slot.type === 'weapon'">
                        ...
                        <div class="roulette-item__image-wrapper weapon-wrapper">
                            ...
                            <span class="corner"></span>
                            <span class="corner"></span>
                            <img :src="slot.items[n-1]" alt="" class="roulette-item__img weapon">
                        </div>
                      </div>
                      <!-- skin -->
                      <div class="item-inner" v-if="slot.type === 'skin'">
          ...
          <Prize v-if="showPrize" @closePrize="showPrize = false" :prize="prizeItem"/>
    ...
    methods: {
      ...
      animate: function(timestamp) {
              ...
              this.opts.forEach( opt => {
                  ...
                  let timeRemaining = Math.max(opt.duration - timeDiff, 0)
                  // skip animations by click
                  if (this.skipAnimation) timeRemaining = 0
                  const power = 1          
